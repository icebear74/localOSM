                ...
                "spec": {
                    ...
                    "initContainers": [
                        ...
                        },
                        {
                            ...
                            # alpine:3.20 is used (instead of busybox) because its wget has a
                            # full OpenSSL TLS stack required by osmdata.openstreetmap.de.
                            "name": "fetch-sources",
                            "image": "alpine:3.20",
                            "command": ["/bin/sh", "-c"],
                            "args": [
...
def wait_for_nominatim_import_if_running(country, timeout_seconds=7200):
    ...
    while time.monotonic() < deadline:
        ...
        # Check if import-finished marker exists
        if os.path.isfile(import_finished_marker):
            # Import is complete (or was never started), safe to proceed
            return
